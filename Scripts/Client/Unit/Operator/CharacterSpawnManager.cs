...
public class CharacterSpawnManager : MonoBehaviour, IInputReceiver
{
    ...
    private void Start()
    {
        ...
        ObjectPoolManager.Register<MeleeOperatorCharacter>(OperatorAttackType.Operator_Melee, m_MeleePrefab, m_MeleeCharacterGroup.transform, 12);
        ObjectPoolManager.Register<RangedOperatorCharacter>(OperatorAttackType.Operator_Ranged, m_RangedPrefab, transform, 12);
